...
public class BoardController {
	...
	/*
	 * @RequestMapping(value = "/listAll", method = RequestMethod.GET) public String
	...
	// 조회 페이지에서 수정 페이지로의 이동
	@RequestMapping(value = "/modifyPage", method = RequestMethod.GET)
	public String modifyPagingGET(@RequestParam("bno") int bno, @ModelAttribute("cri") Criteria cri, Model model)
			throws Exception {
		model.addAttribute(service.read(bno));
